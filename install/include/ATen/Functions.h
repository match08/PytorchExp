...
static inline Tensor _per_channel_affine_qtensor(const Tensor & self, const Tensor & scale, const Tensor & zero_point, IntArrayRef axis);
...
static inline std::tuple<Tensor,Tensor,Tensor> convolution_backward_overrideable(const Tensor & grad_output, const Tensor & input, const Tensor & weight, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool transposed, IntArrayRef output_padding, int64_t groups, std::array<bool,3> output_mask) {
    ...
    return table->getOp<std::tuple<Tensor,Tensor,Tensor> (const Tensor &, const Tensor &, const Tensor &, IntArrayRef, IntArrayRef, IntArrayRef, bool, IntArrayRef, int64_t, std::array<bool,3>)>(at::detail::infer_backend(grad_output), at::detail::infer_is_variable(grad_output))(grad_output, input, weight, stride, padding, dilation, transposed, output_padding, groups, output_mask);
#endif
}
static inline Tensor _convolution(const Tensor & input, const Tensor & weight, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool transposed, IntArrayRef output_padding, int64_t groups, bool benchmark, bool deterministic, bool cudnn_enabled) {
#ifdef USE_STATIC_DISPATCH
...
static inline Tensor _empty_per_channel_affine_quantized_like(const Tensor & self, const Tensor & zero_points, IntArrayRef size, IntArrayRef axis, const TensorOptions & options, c10::optional<MemoryFormat> memory_format) {
    ...
    switch(options.backend()) {
        case Backend::QuantizedCPU:
            ...
            break;
        default:
            AT_ERROR("_empty_per_channel_affine_quantized_like not implemented for ", at::toString(options.backend()));
    }
#else
    globalLegacyTypeDispatch().initForBackend(options.backend());
    ...
    return table->getOp<Tensor (const Tensor &, const Tensor &, IntArrayRef, IntArrayRef, const TensorOptions &, c10::optional<MemoryFormat>)>(options.backend(), options.is_variable())(self, zero_points, size, axis, options, memory_format);
#endif
}
...
static inline Tensor transpose(const Tensor & self, Dimname dim0, Dimname dim1) {
    ...
    return table->getOp<Tensor (const Tensor &, Dimname, Dimname)>(at::detail::infer_backend(self), at::detail::infer_is_variable(self))(self, dim0, dim1);
#endif
}
#endif
static inline Tensor _mkldnn_transpose(const Tensor & self, int64_t dim0, int64_t dim1) {
...
static inline Tensor q_per_channel_scales(const Tensor & self) {
    ...
    switch(at::detail::infer_backend(self)) {
        case Backend::QuantizedCPU:
            ...
            break;
        default:
            AT_ERROR("q_per_channel_scales not implemented for ", at::toString(at::detail::infer_backend(self)));
    }
#else
...
static inline Tensor q_per_channel_zero_points(const Tensor & self) {
    ...
    switch(at::detail::infer_backend(self)) {
        case Backend::QuantizedCPU:
            ...
            break;
        default:
            AT_ERROR("q_per_channel_zero_points not implemented for ", at::toString(at::detail::infer_backend(self)));
    }
#else
...
static inline Tensor _per_channel_affine_qtensor(const Tensor & self, const Tensor & scale, const Tensor & zero_point, IntArrayRef axis) {
    ...
    switch(at::detail::infer_backend(self)) {
        case Backend::CPU:
            return CPUType::_per_channel_affine_qtensor(self, scale, zero_point, axis);
            break;
        default:
            AT_ERROR("_per_channel_affine_qtensor not implemented for ", at::toString(at::detail::infer_backend(self)));
    }
#else
    static auto table = globalATenDispatch().getOpTable("aten::_per_channel_affine_qtensor(Tensor self, Tensor scale, Tensor zero_point, int[] axis) -> Tensor");
    return table->getOp<Tensor (const Tensor &, const Tensor &, const Tensor &, IntArrayRef)>(at::detail::infer_backend(self), at::detail::infer_is_variable(self))(self, scale, zero_point, axis);
#endif
}
static inline Tensor fake_quantize_per_tensor_affine(const Tensor & self, double scale, int64_t zero_point, int64_t quant_min, int64_t quant_max) {
#ifdef USE_STATIC_DISPATCH
...
static inline Tensor erfinv(const Tensor & self) {
#ifdef USE_STATIC_DISPATCH
    return TypeDefault::erfinv(self);
#else
