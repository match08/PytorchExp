...
CAFFE2_API Tensor & _ceil_out_cpu(Tensor & out, const Tensor & self);
CAFFE2_API Tensor & _ceil_out_cuda(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & _expm1_out_cpu(Tensor & out, const Tensor & self);
CAFFE2_API Tensor & _expm1_out_cuda(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & _floor_out_cpu(Tensor & out, const Tensor & self);
CAFFE2_API Tensor & _floor_out_cuda(Tensor & out, const Tensor & self);
...
CAFFE2_API std::tuple<Tensor,Tensor,Tensor,Tensor> batch_norm_backward_reduce_cuda(const Tensor & grad_out, const Tensor & input, const Tensor & mean, const Tensor & invstd, bool input_g, bool weight_g, bool bias_g);
...
CAFFE2_API Tensor & _round_out_cpu(Tensor & out, const Tensor & self);
CAFFE2_API Tensor & _round_out_cuda(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & _rsqrt_out_cpu(Tensor & out, const Tensor & self);
CAFFE2_API Tensor & _rsqrt_out_cuda(Tensor & out, const Tensor & self);
#ifdef BUILD_NAMEDTENSOR
...
CAFFE2_API Tensor & add_out_dense_sparse_cpu(Tensor & out, const Tensor & self, const Tensor & other, Scalar alpha=1);
CAFFE2_API Tensor & add_out_dense_sparse_cuda(Tensor & out, const Tensor & self, const Tensor & other, Scalar alpha=1);
CAFFE2_API Tensor & div_out_sparse_zerodim(Tensor & out, const Tensor & self, const Tensor & other);
CAFFE2_API Tensor & div_out_sparse_scalar(Tensor & out, const Tensor & self, Scalar other);
...
CAFFE2_API Tensor & mul_out_sparse_zerodim(Tensor & out, const Tensor & self, const Tensor & other);
CAFFE2_API Tensor & mul_out_sparse_scalar(Tensor & out, const Tensor & self, Scalar other);
...
CAFFE2_API Tensor & _trunc_out_cpu(Tensor & out, const Tensor & self);
CAFFE2_API Tensor & _trunc_out_cuda(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & s_addmm_out_sparse_dense_cpu(Tensor & out, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1);
CAFFE2_API Tensor & s_addmm_out_sparse_dense_cuda(Tensor & out, const Tensor & self, const Tensor & mat1, const Tensor & mat2, Scalar beta=1, Scalar alpha=1);
...
CAFFE2_API Tensor quantize_linear_cpu(const Tensor & self, double scale, int64_t zero_point, ScalarType dtype);
CAFFE2_API Tensor quantize_linear_per_channel_cpu(const Tensor & self, const Tensor & scales, const Tensor & zero_points, IntArrayRef axis, ScalarType dtype);
...
CAFFE2_API std::tuple<Tensor,Tensor,Tensor> quantized_lstm(const Tensor & input, TensorList hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first, c10::optional<ScalarType> dtype=c10::nullopt);
...
CAFFE2_API Tensor & quantized_adaptive_avg_pool2d_out(Tensor & out, const Tensor & self, IntArrayRef output_size);
